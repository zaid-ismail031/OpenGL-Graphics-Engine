...
namespace OpenGL_Graphics_Engine_UWP
{
    namespace OpenGL_Graphics_Engine_UWP_XamlTypeInfo
    {
...
[::Windows::Foundation::Metadata::DefaultOverload]
::Windows::UI::Xaml::Markup::IXamlType^ ::OpenGL_Graphics_Engine_UWP::OpenGL_Graphics_Engine_UWP_XamlTypeInfo::XamlMetaDataProvider::GetXamlType(::Windows::UI::Xaml::Interop::TypeName type)
{
    return Provider->GetXamlTypeByType(type);
}

::Windows::UI::Xaml::Markup::IXamlType^ ::OpenGL_Graphics_Engine_UWP::OpenGL_Graphics_Engine_UWP_XamlTypeInfo::XamlMetaDataProvider::GetXamlType(Platform::String^ fullName)
{
    return Provider->GetXamlTypeByName(fullName);
}

Platform::Array<::Windows::UI::Xaml::Markup::XmlnsDefinition>^ ::OpenGL_Graphics_Engine_UWP::OpenGL_Graphics_Engine_UWP_XamlTypeInfo::XamlMetaDataProvider::GetXmlnsDefinitions()
{
    return ref new Platform::Array<::Windows::UI::Xaml::Markup::XmlnsDefinition>(0);
}

::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider^ ::OpenGL_Graphics_Engine_UWP::OpenGL_Graphics_Engine_UWP_XamlTypeInfo::XamlMetaDataProvider::Provider::get()
{
